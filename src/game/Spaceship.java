...
public class Spaceship extends Sprite {
     ...
     *
     * @param deltaTime Number of seconds that have elapsed since the last update
     */
    @Override
     ...
     *
     * @param state {@link SpaceshipState State} to set to
     */
     ...
     *
     * @param direction {@link SpaceshipEngineDirection Direction} the engine is facing
     */
